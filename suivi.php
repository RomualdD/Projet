      ...
      <div class="row">
        <table class="tableresult table table-bordered result col-lg-offset-2 col-lg-3">
          ...
          <tbody>
              ...
              $requestbdd = $bdd->query('SELECT `date_du_jour`, `resultat`, `date_prochaine_verif` FROM `suivis` WHERE `id_utilisateur` = "'.$id.'"ORDER BY `id` DESC limit '.$first.', '.$nbPagesForResult);
