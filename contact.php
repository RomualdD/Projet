...
<!-- Page contact -->
  <div class="container">
    ...
    <div class="message col-lg-offset-2"><p>Veuillez entrer votre Nom, Prénom et votre adresse mail pour obtenir une réponse à votre message.</p>
      ...
      <div class="contact col-lg-offset-3 col-lg-9">
        <div class="row">
          ...
          <form action="contact.php" method="POST">
            ...
            <textarea rows="10" cols="100" placeholder="Veuillez entrer votre remarque, question ou information." name="message"></textarea>
