...
<!-- Page d'accueil -->
  <div class="container">
    ...
    <div class="row">
      <div class="welcome col-lg-offset-2"><h3>Bienvenue sur le site Titre!</h3></div>
      <div class="subhead col-lg-offset-1"><h4>Pour qui est ce site?</h4></div>
      <p>Ce site est dédié aux personnes atteintes du Diabète ou de problème de santé nécessitant la prise d'anticoagulant (AVK) et utilisant principalement des appareils (par exemple coagucheck). Vous pourrez noter les résultats de vos prise de sang composant le suivi de votre diabète ou INR et ainsi observer l'évolution instantanéement à chaque prise de sang.</p>
      <p>titre permet de vous aider à vous souvenir du moment où vous devez faire votre prise de sang grâce à un envoi de mail ou de SMS, et de noter vos rendez-vous médicaux.</p>
      <p>Il permet aussi à votre médecin de pouvoir suivre en même temps que vous les résultats de votre taux de Glycémie ou d'INR et peuvent être observés lors de vos consultations.</p>
