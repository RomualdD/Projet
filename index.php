...
<!-- Page d'accueil -->
  <div class="container">
    ...
    <div class="row">
      ...
      <p>Lors de l'inscription, il est nécessaire d'indiquer la pathologie qui vous concerne. Ensuite il faut rempli les données de la fiche profile qui seront nécessaires dans le cadre du suivi. Celles-ci seront stockées et permettront d'actualiser les informations.</p>
